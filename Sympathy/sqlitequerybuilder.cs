...
namespace Sympathy
{
	...
	{
		public SqliteQueryBuilder (Table table = null, QueryType type = QueryBuilder.QueryType.Select) : base (table, type)
		{
		}
		
		protected override string insertQuery (IDictionary <string, object> values)
		{
			string query = "INSERT INTO {0} ({1}) VALUES ({2}); SELECT last_insert_rowid();";
